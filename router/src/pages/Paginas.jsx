...
export function HomePage() {
  return (
    <div>
      ...
      <p>
        En el Tec de Monterrey innovamos continuamente nuestra oferta académica para que siempre responda a los cambios sociales,
        económicos, laborales, científicos y tecnológicos.
      </p>
      <p>
        Tus profesores te retarán continua y deliberadamente a plantear y resolver problemas.
        Ya no más materias como las conocías, con conocimientos no necesariamente conectados entre sí.
        Retos continuos en entornos diversos para forjar en ti la persona que estás llamada a ser.
      </p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <p>
        ...
        tincidunt, nunc nisi bibendum nunc, eu tincidunt nunc nisi eu nunc.
        Sed sollicitudin, nunc et facilisis tincidunt, nunc nisi bibendum
        nunc, eu tincidunt nunc nisi eu nunc.
      </p>
    </div>
  );
}
...
export function CountryPage() {
  const { paisId, estado } = useParams();
  return (
    <div>
      <h1>Página de {paisId}</h1>
      <p>Estado: {estado}</p>
    </div>
  );
}
